...
Config::$serverKey = 'SB-Mid-server-3NG-rd-IPdNDyX7fUSgyiVXY';
...
if ($transaction == 'capture') {
    ...
    $query = "update tbl_transaksi set status='$notif->status_code',transaction_status='$transaction' where no_order = $order_id";
    $exec = mysqli_query($conn,$query);

    $query2 = "update tbl_pemesanan set status_bayar='1' where no_order = $order_id ";
